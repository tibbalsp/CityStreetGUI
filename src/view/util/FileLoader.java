    ...
    private static List<Vehicle> readVehicles(final Scanner theInput) {
        ...
        for (int lineCount = 0; lineCount < numVehicles; lineCount++) {
            ...
            switch (vehicleType) {
              ...
              case 'B': // Bicycle
                    vehicles.add(new Bicycle(vehicleX, vehicleY,Direction.valueOf(vehicleDirection)));
                    break;

                case 'A': //ATV
                    vehicles.add(new ATV(vehicleX, vehicleY,Direction.valueOf(vehicleDirection)));
                    break;
                ...
                case 'T': // Truck
                    vehicles.add(new Truck(vehicleX, vehicleY,Direction.valueOf(vehicleDirection)));
                    break;
                    
                case 'X': // Taxi
                    vehicles.add(new Taxi(vehicleX, vehicleY,Direction.valueOf(vehicleDirection)));
                    break;
                    
                case 'C': // Car
                    vehicles.add(new Car(vehicleX, vehicleY,Direction.valueOf(vehicleDirection)));
                    break;
